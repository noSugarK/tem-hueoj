...
<div class="padding">
    <div class="ui three column grid">
        <div class="eleven wide column">
            <?php if(file_exists("image/photo1.jpg")){ ?>
            ...
            <div class="ui bottom attached center aligned segment carousel">
                ...
                <?php for($i=1;file_exists("image/photo$i.jpg");$i++){ ?>
                <div class="carousel-slide <?php if($i==1) echo "active";?>" style="background-image: url('image/photo<?php echo $i ?>.jpg')"></div>
                <?php } ?>
