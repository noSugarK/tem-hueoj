...
<div class="padding">
    <h1>Contest<?php echo $view_cid?> - <?php echo $view_title ?><?php if(isset($_SESSION[$OJ_NAME.'_'.'administrator']) || isset($_SESSION[$OJ_NAME.'_m'.$cid ])) {?>
          <a class="ui small blue button" href="contestrank3.php?cid=<?php echo $view_cid?>">滚榜</a><?php } ?></h1>
